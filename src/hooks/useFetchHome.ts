...
import { HomeProductApiResponse } from "@/lib/types/home-product";
import { useQuery } from "@tanstack/react-query";



// Fetch function
const fetchData = async <T>(endpoint: string): Promise<HomeProductApiResponse<T>> => {
...
// Custom Hook
export function useFetchHome<T>(endpoint: string) {
  return useQuery({
    queryKey: [endpoint],
